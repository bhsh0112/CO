...
#endif
static const char *ng0 = "/home/co-eda/Desktop/homework/P/P5/cpu_v3/E_ALU.v";
...
LAB14:    if (*((unsigned int *)t16) < *((unsigned int *)t19))
        goto LAB12;
...
LAB16:    xsi_set_current_line(47, ng0);
    ...
    t18 = *((char **)t17);
    memset(t20, 0, 8);
    xsi_vlog_unsigned_minus(t20, 32, t15, 32, t18, 5);
    ...
    t29 = (t24 + 56U);
    t30 = *((char **)t29);
    xsi_vlog_generic_convert_bit_index(t31, t23, 2, t30, 32, 1);
    t32 = (t31 + 4);
    t8 = *((unsigned int *)t32);
    t40 = (!(t8));
    if (t40 == 1)
...
LAB18:    xsi_vlogvar_assign_value(t30, t29, 0, *((unsigned int *)t31), 1);
    goto LAB19;

LAB20:    xsi_vlogvar_assign_value(t19, t4, 0, *((unsigned int *)t31), 1);
    goto LAB21;

}


extern void work_m_15501157307989680566_4245161272_init()
{
	static char *pe[] = {(void *)Cont_33_0,(void *)Always_43_1};
	xsi_register_didat("work_m_15501157307989680566_4245161272", "isim/mips_tb_isim_beh.exe.sim/work/m_15501157307989680566_4245161272.didat");
