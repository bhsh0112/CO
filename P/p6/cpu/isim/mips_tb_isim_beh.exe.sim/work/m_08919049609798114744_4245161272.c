...
#endif
static const char *ng0 = "/home/co-eda/Desktop/homework/P/p6/cpu/E_ALU.v";
...
LAB96:    if (*((unsigned int *)t214) < *((unsigned int *)t215))
        goto LAB94;

LAB95:    t219 = ((char*)((ng1)));
    xsi_vlogtype_concat(t212, 32, 32, 2U, t219, 31, t216, 1);
    goto LAB84;
...
LAB85:    t224 = (t0 + 1048U);
    ...
    t226 = *((char **)t224);
    memset(t227, 0, 8);
    xsi_vlog_unsigned_add(t227, 32, t225, 32, t226, 32);
    goto LAB86;

LAB87:    xsi_vlog_unsigned_bit_combine(t181, 32, t212, 32, t227, 32);
    goto LAB91;
