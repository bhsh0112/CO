...
#endif
static const char *ng0 = "/home/co-eda/Desktop/homework/P/p7/cpu_v1/CP0.v";
static int ng1[] = {14, 0};
static int ng2[] = {0, 0};
static int ng3[] = {32, 0};
...
LAB87:    xsi_set_current_line(78, ng0);
    ...
    t22 = ((char*)((ng13)));
    t23 = ((char*)((ng14)));
    xsi_vlog_convert_partindices(t16, t41, t42, ((int*)(t21)), 2, t22, 32, 1, t23, 32, 1);
    t24 = (t13 + 4);
    t6 = *((unsigned int *)t24);
    t28 = (!(t6));
    t25 = (t15 + 4);
...
LAB40:    t14 = (t0 + 3688);
    ...
    t23 = *((char **)t22);
    t24 = ((char*)((ng1)));
    xsi_vlog_generic_convert_array_indices(t41, t42, t20, t23, 2, 1, t24, 32, 1);
    t25 = (t41 + 4);
...
LAB55:    t12 = (t0 + 3688);
    ...
    t22 = *((char **)t21);
    t23 = ((char*)((ng9)));
    xsi_vlog_generic_convert_array_indices(t41, t42, t19, t22, 2, 1, t23, 32, 1);
    t24 = (t0 + 3688);
    t25 = (t24 + 72U);
    t26 = *((char **)t25);
    t29 = ((char*)((ng10)));
    t50 = ((char*)((ng11)));
    xsi_vlog_convert_partindices(t47, t48, t49, ((int*)(t26)), 2, t29, 32, 1, t50, 32, 1);
    t51 = (t41 + 4);
...
LAB36:    xsi_vlog_unsigned_bit_combine(t13, 32, t16, 32, t17, 32);
    goto LAB40;
...
LAB41:    t45 = *((unsigned int *)t41);
    ...
    t35 = (t45 - t46);
    t36 = (t35 + 1);
    xsi_vlogvar_wait_assign_value(t14, t13, 0, *((unsigned int *)t42), t36, 0LL);
    goto LAB42;
...
LAB51:    xsi_vlog_unsigned_bit_combine(t13, 32, t11, 32, t16, 32);
    goto LAB55;

LAB53:    memcpy(t13, t11, 8);
    goto LAB55;

LAB56:    t60 = *((unsigned int *)t49);
    t61 = (t60 + 0);
    ...
    t67 = (t65 - t66);
    t68 = (t67 + 1);
    xsi_vlogvar_wait_assign_value(t12, t13, t61, t64, t68, 0LL);
    goto LAB57;

LAB58:    t9 = *((unsigned int *)t15);
...
LAB88:    t27 = *((unsigned int *)t42);
    ...
    t67 = (t34 - t37);
    t68 = (t67 + 1);
    xsi_vlogvar_wait_assign_value(t2, t3, t61, t64, t68, 0LL);
    goto LAB89;
...
extern void work_m_08886563985825645967_3975733304_init()
{
	...
	xsi_register_didat("work_m_08886563985825645967_3975733304", "isim/mips_isim_beh.exe.sim/work/m_08886563985825645967_3975733304.didat");
