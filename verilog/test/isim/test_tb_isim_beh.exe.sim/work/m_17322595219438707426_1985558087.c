...
LAB20:    t226 = (t0 + 3080);
    ...
    *((unsigned int *)t236) = (t238 | t232);
    xsi_driver_vfirst_trans(t226, 0, 4);
    t239 = (t0 + 3000);
    *((int *)t239) = 1;
...
LAB16:    xsi_vlog_unsigned_bit_combine(t3, 5, t36, 5, t71, 5);
    goto LAB20;
...
LAB36:    xsi_vlog_unsigned_bit_combine(t71, 5, t105, 5, t136, 5);
    goto LAB40;
...
LAB56:    xsi_vlog_unsigned_bit_combine(t136, 5, t170, 5, t187, 5);
    goto LAB60;
...
LAB72:    t218 = (t0 + 1048U);
    ...
    t220 = *((char **)t218);
    memset(t221, 0, 8);
    xsi_vlog_unsigned_add(t221, 5, t219, 4, t220, 4);
    goto LAB73;

LAB74:    t218 = ((char*)((ng1)));
    goto LAB75;

LAB76:    xsi_vlog_unsigned_bit_combine(t187, 5, t221, 5, t218, 5);
    goto LAB80;
...
extern void work_m_17322595219438707426_1985558087_init()
{
	static char *pe[] = {(void *)Cont_27_0};
	xsi_register_didat("work_m_17322595219438707426_1985558087", "isim/test_tb_isim_beh.exe.sim/work/m_17322595219438707426_1985558087.didat");
